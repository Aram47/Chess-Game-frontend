...
export const AnalyzeIcon = ({ games, theme }: AnalyzeIconProps) => {
  const iconColor = theme === "dark" ? "#A39589" : "#6B6B6B";

  return (
    <div className="rounded-full bg-[#E5CC7A14] border border-[#E5CC7A14] flex justify-center items-center w-10 h-10">
      {games.length === 0 ? (
        <svg
          width="24"
          height="24"
